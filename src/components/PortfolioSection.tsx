...
export default function PortfolioSection() {
  ...
  return (
    <section id="work" className="relative py-20 md:py-32" ref={ref}>
      ...
      {/* Discord Servers sub-section */}
      <div className="px-6 md:px-12 mt-24 mb-12">
        <motion.div
          className="flex items-center gap-4 mb-4"
          initial={{ opacity: 0, x: -30 }}
          whileInView={{ opacity: 1, x: 0 }}
        ...
        >
          <div className="h-[1px] w-12 bg-white/20" />
          <span className="font-outfit text-[10px] tracking-[0.5em] text-white/30 uppercase">Discord Servers</span>
        </motion.div>
        <div className="overflow-hidden mb-10">
          <motion.h3
            className="font-bebas text-[clamp(2rem,5vw,4rem)] leading-none tracking-[0.05em] text-bone"
            initial={{ y: '100%' }}
            whileInView={{ y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, ease: [0.76, 0, 0.24, 1] }}
        ...
        <div className="flex flex-wrap gap-8">
          <motion.a
            href="https://discord.gg/nTm4V8X9Xs"
            target="_blank"
          ...
          >
            ...
            >
              <motion.img
                src="/images/solitude-server.png"
                alt="Solitude Discord Server"
              ...
              >
                <div className="flex items-center gap-2 border border-white/30 px-5 py-2">
                  ...
                  <span className="font-outfit text-[10px] tracking-[0.3em] text-bone">JOIN SERVER</span>
                </div>
              </motion.div>
              <motion.div
                className="absolute inset-0 border border-white/0 group-hover:border-white/20 transition-colors duration-300"
              />
            </motion.div>
            <div className="mt-4 flex items-center justify-between">
              <div>
                <h4 className="font-bebas text-xl tracking-[0.1em] text-bone">SOLITUDE</h4>
                <p className="font-outfit text-[9px] tracking-[0.3em] text-white/30 uppercase mt-0.5">Discord Server · Manager</p>
              </div>
